...
bot.on('callback_query', async (query) => {
    ...
    switch (data) {
        ...
        case 'resetwallet':
            ...
            let reest_txt;
            if (walletbalance > 0) {
                reest_txt = `Are you sure you want to <b>reset</b> your VertexTradingBot <b>Wallet</b>?\n\n` +
        ...
        case 'confirmreset':
            ...
            const txt = `<b>CONFIRM</b>: Are you sure you want to <b>reset</b> your VertexTradingBot <b>Wallet</b>?\n\n` +
